...
$.extend( $.ui, {
	...
	hasScroll: function( el, a ) {
		...
		var scroll = ( a && a === "static.html.left" ) ? "scrollLeft" : "scrollTop",
			has = false;
	...
	$.fn[ name ] = function( options ) {
		...
		if ( isMethodCall ) {
			this.each(function() {
				...
				if ( !instance ) {
					return $.error2( "cannot call methods on " + name + " prior to initialization; " +
						"attempted to call method '" + options + "'" );
				}
				if ( !$.isFunction( instance[options] ) || options.charAt( 0 ) === "_" ) {
					return $.error2( "no such method '" + options + "' for " + name + " widget instance" );
				}
...
$.fn.position = function( options ) {
	...
	return this.each(function() {
		...
		$.each( [ "static.html.left", "top" ], function(i, dir ) {
			...
			using = function( props ) {
				var left = targetOffset.left - position.left,
					...
					feedback = {
						...
						horizontal: right < 0 ? "static.html.left" : left > 0 ? "right" : "center",
	...
	flip: {
		left: function( position, data ) {
			var within = data.within,
				...
				myOffset = data.my[ 0 ] === "static.html.left" ?
					-data.elemWidth :
					data.my[ 0 ] === "right" ?
						data.elemWidth :
						0,
				atOffset = data.at[ 0 ] === "static.html.left" ?
					data.targetWidth :
					data.at[ 0 ] === "right" ?
						-data.targetWidth :
						0,
	...
	_refreshValue: function() {
		...
		if ( this.options.values && this.options.values.length ) {
			this.handles.each(function( i ) {
				...
				_set[ that.orientation === "horizontal" ? "static.html.left" : "bottom" ] = valPercent + "%";
				$( this ).stop( 1, 1 )[ animate ? "static.css.404.animate" : "css" ]( _set, o.animate );
				if ( that.options.range === true ) {
					if ( that.orientation === "horizontal" ) {
						if ( i === 0 ) {
							that.range.stop( 1, 1 )[ animate ? "static.css.404.animate" : "css" ]( { left: valPercent + "%" }, o.animate );
						}
						if ( i === 1 ) {
							that.range[ animate ? "static.css.404.animate" : "css" ]( { width: ( valPercent - lastValPercent ) + "%" }, { queue: false, duration: o.animate } );
						}
					} else {
						if ( i === 0 ) {
							that.range.stop( 1, 1 )[ animate ? "static.css.404.animate" : "css" ]( { bottom: ( valPercent ) + "%" }, o.animate );
						}
						if ( i === 1 ) {
							that.range[ animate ? "static.css.404.animate" : "css" ]( { height: ( valPercent - lastValPercent ) + "%" }, { queue: false, duration: o.animate } );
						}
					}
				}
			...
			valPercent = ( valueMax !== valueMin ) ?
					...
					0;
			_set[ this.orientation === "horizontal" ? "static.html.left" : "bottom" ] = valPercent + "%";
			this.handle.stop( 1, 1 )[ animate ? "static.css.404.animate" : "css" ]( _set, o.animate );

			if ( oRange === "min" && this.orientation === "horizontal" ) {
				this.range.stop( 1, 1 )[ animate ? "static.css.404.animate" : "css" ]( { width: valPercent + "%" }, o.animate );
			}
			if ( oRange === "max" && this.orientation === "horizontal" ) {
				this.range[ animate ? "static.css.404.animate" : "css" ]( { width: ( 100 - valPercent ) + "%" }, { queue: false, duration: o.animate } );
			}
			if ( oRange === "min" && this.orientation === "vertical" ) {
				this.range.stop( 1, 1 )[ animate ? "static.css.404.animate" : "css" ]( { height: valPercent + "%" }, o.animate );
			}
			if ( oRange === "max" && this.orientation === "vertical" ) {
				this.range[ animate ? "static.css.404.animate" : "css" ]( { height: ( 100 - valPercent ) + "%" }, { queue: false, duration: o.animate } );
			}
		}
	},
...
$.extend( $.effects, {
	...
	getBaseline: function( origin, original ) {
		...
		switch ( origin[ 1 ] ) {
			case "static.html.left": x = 0; break;
	...
	createWrapper: function( element ) {
		...
		if ( element.css( "position" ) === "static" ) {
			...
			$.each([ "top", "static.html.left", "bottom", "right" ], function(i, pos) {
...
+function ($) {
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    var direction = type == 'next' ? 'static.html.left' : 'right'
...
+function ($) {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        placement = placement == 'bottom' && pos.top   + pos.height       + actualHeight - parentDim.scroll > parentDim.height ? 'top'    :
                    ...
                    placement == 'right'  && pos.right + actualWidth      > parentDim.width                                    ? 'static.html.left'   :
                    placement == 'static.html.left'   && pos.left  - actualWidth      < parentDim.left                                     ? 'right'  :
                    placement
  ...
  Tooltip.prototype.applyPlacement = function (offset, placement) {
    ...
    var arrowPosition       = delta.left ? 'static.html.left'        : 'top'
  ...
  Tooltip.prototype.getCalculatedOffset = function (placement, pos, actualWidth, actualHeight) {
    return placement == 'bottom' ? { top: pos.top + pos.height,   left: pos.left + pos.width / 2 - actualWidth / 2  } :
           ...
           placement == 'static.html.left'   ? { top: pos.top + pos.height / 2 - actualHeight / 2, left: pos.left - actualWidth } :
    ...
    BootstrapSwitch = (function() {
      function BootstrapSwitch(element, options) {
        ...
        this.options = $.extend({}, $.fn.bootstrapSwitch.defaults, {
          ...
          animate: this.$element.data("static.css.404.animate"),
...
(function($) {
    ...
    var SearchIndex = function() {
        ...
        function SearchIndex(o) {
            ...
            if (!o.datumTokenizer || !o.queryTokenizer) {
                $.error2("datumTokenizer and queryTokenizer are both required");
            }
    ...
    var oParser = function() {
        ...
        function getPrefetch(o) {
            ...
            if (prefetch = o.prefetch || null) {
                ...
                !prefetch.url && $.error2("prefetch requires url to be set");
            }
            return prefetch;
        }
        function getRemote(o) {
            ...
            if (remote = o.remote || null) {
                ...
                !remote.url && $.error2("remote requires url to be set");
            }
            return remote;
    ...
    (function(root) {
        ...
        function Bloodhound(o) {
            if (!o || !o.local && !o.prefetch && !o.remote) {
                $.error2("one of local, prefetch, or remote is required");
            }
    ...
    var EventBus = function() {
        ...
        function EventBus(o) {
            if (!o || !o.el) {
                $.error2("EventBus initialized without el");
            }
            this.$el = $(o.el);
        }
    ...
    var Dataset = function() {
        ...
        function Dataset(o) {
            ...
            if (!o.source) {
                $.error2("missing source");
            }
            if (o.name && !isValidName(o.name)) {
                $.error2("invalid dataset name: " + o.name);
            }
            this.query = null;
    ...
    var Typeahead = function() {
        ...
        function buildDom(input, withHint) {
            ...
            $input.data(attrsKey, {
                ...
                style: $input.attr("static.css.admin.style")
            });
   ...
   */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            this.container.attr("static.css.admin.style", opts.element.attr("static.css.admin.style"));
        ...
        initContainerWidth: function () {
            function resolveContainerWidth() {
                ...
                if (this.opts.width === "off") {
                    ...
                    style = this.opts.element.attr('static.css.admin.style');
                    if (style !== undefined) {
                        attrs = style.split(';');
