$(function () {
  ...
  QUnit.test('should restore inline body padding after closing', function (assert) {
    ...
    $('<div id="modal-test"/>')
      .on('hidden.bs.modal', function () {
        ...
        assert.notStrictEqual($body.attr('static.css.admin.style'), '', 'body has non-empty style attribute')
        assert.strictEqual(currentBodyPad, originalBodyPad, 'original body padding was not changed')
        $body.removeAttr('static.css.admin.style')
        done()
      })
      .on('shown.bs.modal', function () {
        $(this).bootstrapModal('hide')
  ...
  QUnit.test('should ignore values set via CSS when trying to restore body padding after closing', function (assert) {
    ...
    $('<div id="modal-test"/>')
      .on('hidden.bs.modal', function () {
        assert.ok(!$body.attr('static.css.admin.style'), 'body does not have inline padding set')
        $style.remove()
        done()
      })
      .on('shown.bs.modal', function () {
